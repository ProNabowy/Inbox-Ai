...
describe("happy scenario to sell fixed vehicle", () => {
    ...
    it("login to Can Sell", () => {
        ...
        cy.get("[data-cy='sell_item_button']").eq(0).click();
        ...
        cy.get("input[placeholder='Please select city']").click().type("Damietta");
        cy.contains("Damietta").eq(0).click();


        cy.get("input[placeholder='Please select area']").click().type("Damietta");
        cy.contains("Damietta").eq(0).click();

        cy.wait(1000);

        cy.get("input[placeholder='Please Select Center']").click().type("New Damiet");
        cy.contains("New Damiet").eq(0).click();
